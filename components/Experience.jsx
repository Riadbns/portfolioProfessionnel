  ...
  return (
    <div id="experience" className="w-full">
      <div className="max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left">
        ...
        Ma section Compétences présente mes connaissances en langages de programmation et montre ma volonté de constamment apprendre de nouvelles technologies.
        </p>
